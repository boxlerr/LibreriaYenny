...
public class Libro {
	...
	public Libro(int idLibro, String titulo, String autor, String genero, int stock, int precio, int idSucursal_fk) {
		super();
	...
	public Libro(String titulo, String autor, String genero, int stock, int precio, int idSucursal_fk) {
		super();
		this.titulo = titulo;
		this.autor = autor;
		this.genero = genero;
