...
public class PantallaAplicarDescuento extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaAplicarDescuento frame = new PantallaAplicarDescuento();
	 ...
	 * Create the frame.
	 */
	public PantallaAplicarDescuento() {
		this.setVisible(true);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 858, 492);
		...
		lblFiltroSucursal.setBounds(10, 374, 255, 13);
		contentPane.add(lblFiltroSucursal);
		
		inpFiltroSucursal = new JTextField();
		inpFiltroSucursal.setBounds(10, 389, 160, 19);
		...
		btnFiltrarAutor.setBounds(440, 389, 85, 21);
		contentPane.add(btnFiltrarAutor);
		
		JLabel lblIngreseUnTitulo = new JLabel("Ingrese un titulo para filtrar");
		lblIngreseUnTitulo.setBounds(275, 418, 255, 13);
		contentPane.add(lblIngreseUnTitulo);
		
		inpFiltrarTitulo = new JTextField();
		inpFiltrarTitulo.setColumns(10);
		inpFiltrarTitulo.setBounds(275, 433, 160, 19);
		contentPane.add(inpFiltrarTitulo);
		
		JLabel lblSeleccioneLibro = new JLabel("Seleccione un libro");
		lblSeleccioneLibro.setForeground(new Color(255, 0, 0));
		lblSeleccioneLibro.setFont(new Font("Tahoma", Font.PLAIN, 9));
		lblSeleccioneLibro.setBounds(381, 310, 79, 13);
		contentPane.add(lblSeleccioneLibro);
		lblSeleccioneLibro.setVisible(false);
		...
		btnFiltrarTitulo.setBounds(440, 432, 85, 21);
		...
		btnEliminarFiltros.setBounds(575, 399, 139, 43);
		...
		btnVolver.setBounds(762, 399, 72, 43);
		...
		btnAplicarDescuento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (libroSeleccionado.getIdLibro()==0) {
					lblSeleccioneLibro.setVisible(true);
				} else {
					dispose();
					Descuento descuento = new Descuento(libroSeleccionado);
				}
				
			}
		});
		btnAplicarDescuento.setBounds(351, 321, 139, 43);
