...
public class EditarLibro extends JFrame {
	...
	public EditarLibro(Libro libro) {
		...
		btnEditar.setBounds(129, 233, 105, 38);
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Libro libroModificado = new Libro(libro.getIdLibro(), inpTitulo.getText(), inpAutor.getText(), inpGenero.getText(), Integer.parseInt(inpStock.getText()), inpPrecio.getText(), Integer.parseInt(inpIdSucursal.getText()));
