...
inpTipo.setBounds(242, 160, 148, 29);
...
btnAgregar.setBounds(76, 211, 89, 45);
...
controlador.addUser(new Usuario(inpMail.getText(), inpContrasena.getText(), inpTipo.getText()));

if (inpTipo.getText().equalsIgnoreCase("Gerente")) {
	gerenteControlador.addGerente(new Gerente(inpMail.getText(), inpContrasena.getText(), inpTipo.getText(), inpNombre.getText(), inpApellido.getText(), Integer.parseInt(inpDni.getText()), 1), controlador.getUserById(inpMail.getName(), inpContrasena.getText()));
}

if (inpTipo.getText().equalsIgnoreCase("Empleado")) {
	empleadoControlador.addEmpleado(new Empleado(inpMail.getText(), inpContrasena.getText(), "Empleado", inpNombre.getText(), inpApellido.getText(), Integer.parseInt(inpDni.getText()), 1), controlador.getUserById(inpMail.getText(), inpContrasena.getText()));
}

if (inpTipo.getText().equalsIgnoreCase("Escritor")) {
...
btnCancelar.setBounds(272, 211, 89, 45);
