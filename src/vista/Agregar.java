			...
			public void actionPerformed(ActionEvent e) {
				...
				if (flagMailExistencia && flagMailValido && flagContrasenaCaracteres && flagContrasenaNumeros && flagContrasenaBlank && 
					...
					if (inpTipo.getText().equalsIgnoreCase("Gerente")) {
						GerenteControlador.addGerente(controlador.getUserById(inpMail.getText(), inpContrasena.getText()), new Gerente(inpMail.getText(), inpContrasena.getText(), "Gerente", inpNombre.getText(), inpApellido.getText(), Integer.parseInt(inpDni.getText())));
					}
					
					if (inpTipo.getText().equalsIgnoreCase("Empleado")) {
						GerenteControlador.addGerente(controlador.getUserById(inpMail.getText(), inpContrasena.getText()), new Empleado(inpMail.getText(), inpContrasena.getText(), "Empleado", inpNombre.getText(), inpApellido.getText(), Integer.parseInt(inpDni.getText())));
					}
