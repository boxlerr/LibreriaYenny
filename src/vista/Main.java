...
//				JOptionPane.showMessageDialog(null, usuarios);
				...
				if (usuarioControlador.getUserById(mail, contraseña)!=null) {
					...
					case "gerente":
						...
						gerenteControlador.getGerenteById(usuarioControlador.getUserById(mail, contraseña)).Ingreso(libroControlador, bibliotecaControlador, usuarioControlador);
						break;
					case "empleado":
						...
						empleadoControlador.getEmpleadoById(usuarioControlador.getUserById(mail, contraseña)).Ingreso(libroControlador, bibliotecaControlador, usuarioControlador);
						break;
					case "escritor":
						...
						escritorControlador.getEscritorById(usuarioControlador.getUserById(mail, contraseña)).Ingreso(libroControlador, bibliotecaControlador, usuarioControlador);
						break;
